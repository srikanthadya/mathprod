 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void sendRequest(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::mathtest::MathReply* response, std::function<void(::grpc::Status)>) = 0;
      ...
      #else
      virtual void sendRequest(::grpc::ClientContext* context, const ::mathtest::MathRequest* request, ::mathtest::MathReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void sendRequest(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::mathtest::MathReply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void sendRequest(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::mathtest::MathReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void sendRequest(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::mathtest::MathReply* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void sendRequest(::grpc::ClientContext* context, const ::mathtest::MathRequest* request, ::mathtest::MathReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void sendRequest(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::mathtest::MathReply* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void sendRequest(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::mathtest::MathReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_sendRequest : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_sendRequest() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::mathtest::MathRequest, ::mathtest::MathReply>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
                     context, const ::mathtest::MathRequest* request, ::mathtest::MathReply* response) { return this->sendRequest(context, request, response); }));}
    void SetMessageAllocatorFor_sendRequest(
        ::grpc::experimental::MessageAllocator< ::mathtest::MathRequest, ::mathtest::MathReply>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(0);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::mathtest::MathRequest, ::mathtest::MathReply>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* sendRequest(
      ::grpc::CallbackServerContext* /*context*/, const ::mathtest::MathRequest* /*request*/, ::mathtest::MathReply* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* sendRequest(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::mathtest::MathRequest* /*request*/, ::mathtest::MathReply* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
